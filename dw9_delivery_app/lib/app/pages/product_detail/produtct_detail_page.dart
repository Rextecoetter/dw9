...
class ProdutctDetailPage extends StatefulWidget {
  final ProductModel product;
  final OrderProductDto? order;
  const ProdutctDetailPage({super.key, required this.product, required this.order});

  @override
  State<ProdutctDetailPage> createState() => _ProdutctDetailPageState();
}

class _ProdutctDetailPageState extends BaseState<ProdutctDetailPage, ProductDetailController> {
  @override
  void initState() {
    super.initState();
